              ...
              <div class="w-full lg:w-1/2">
                <div class="flex flex-col items-center justify-center">
                  ...
                  <div class="w-full lg:w-1/3 text-center">
                    <div class="border bg-gray-200 my-6 rounded-lg h-36">
                    ...
                    <div class="bg-gray-200 rounded p-5">
                      <ul>
                        ...
                        <div class="px-2 flex gap-5 my-10">
                            <RouterLink to="/" class="w-full px-3 py-2 lg:tracking-wide bg-primary hover:bg-white border border-primary hover:text-primary
                                text-white text-center transition-all ease-in-out duration-500">Complete Order</RouterLink>
                        </div>
                    </div>
                  </div>
                </div>
